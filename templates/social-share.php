<section id="<?php echo 'social-share-' . get_the_ID(); ?>" class="single-social">
    ...
    <div class="single-section-container">
        ...
        <a href="https://twitter.com/share" class="twitter-share-button" data-via="<?php echo TWITTER_USERNAME; ?>" data-related="<?php echo TWITTER_USERNAME; ?>" data-count="vertical" data-lang="id">Tweet</a>
